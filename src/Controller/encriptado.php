...
namespace App\Controller;
    ...
    //use Symfony\Crypto\Crypto;
    //use Symfony\Crypto\Key;
    //use Symfony\Crypto\Key\Exception\WrongKeyOrModifiedCiphertextException;
class encriptado{
	...
	$mensajeCifrado = Defuse\Crypto\Crypto::encrypt($texto, $clave);
