...
return [
    ...
    'excel' => [[], ['_controller' => 'App\\Controller\\ExcelController::excel'], [], [['text', '/admin/excel']], [], []],
    'crearNovedad' => [['fecha', 'numero', 'titulo', 'email', 'version', 'id'], ['_controller' => 'App\\Controller\\FuncionesController::crearNovedad'], [], [['variable', '/', '[^/]++', 'id', true], ['variable', '/', '[^/]++', 'version', true], ['variable', '/', '[^/]++', 'email', true], ['variable', '/', '[^/]++', 'titulo', true], ['variable', '/', '[^/]++', 'numero', true], ['variable', '/', '[^/]++', 'fecha', true], ['text', '/novedad']], [], []],
    ...
    'nuevaNovedad' => [[], ['_controller' => 'App\\Controller\\NovedadesController::nuevaNovedad'], [], [['text', '/admin/nuevaNovedad']], [], []],
    'modificarNovedad' => [['id'], ['_controller' => 'App\\Controller\\NovedadesController::modificarNovedad'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/modificarNovedad']], [], []],
